...
.method public static evaluate(Ljava/lang/Object;Lorg/jaxen/Navigator;)Ljava/lang/String;
    ...
    .line 284
    .local v2, "childAxisIterator":Ljava/util/Iterator;
    :cond_5
    ...
    .line 287
    .local v3, "descendant":Ljava/lang/Object;
    invoke-interface {p1, v3}, Lorg/jaxen/Navigator;->isElement(Ljava/lang/Object;)Z
    ...
    .line 289
    invoke-interface {p1, v3}, Lorg/jaxen/Navigator;->getElementStringValue(Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 293
    .end local v2    # "childAxisIterator":Ljava/util/Iterator;
    .end local v3    # "descendant":Ljava/lang/Object;
    :cond_6
    ...
    invoke-static {v6}, Lorg/jaxen/function/StringFunction;->stringValue(Z)Ljava/lang/String;
    ...
    invoke-static {v6, v7}, Lorg/jaxen/function/StringFunction;->stringValue(D)Ljava/lang/String;
    :try_end_0
    ...
    .line 327
    .local v4, "e":Lorg/jaxen/UnsupportedAxisException;
    new-instance v6, Lorg/jaxen/JaxenRuntimeException;

    invoke-direct {v6, v4}, Lorg/jaxen/JaxenRuntimeException;-><init>(Ljava/lang/Throwable;)V

    throw v6

    .line 330
    .end local v4    # "e":Lorg/jaxen/UnsupportedAxisException;
    :cond_d
    const-string p0, ""
