...
# static fields
.field private static final BACKGROUND_DEFAULT_STATE_1:[I

.field private static final BACKGROUND_DEFAULT_STATE_2:[I

.field private static final BACKGROUND_DISABLED_STATE:[I

.field private static final BACKGROUND_FOCUSED_STATE:[I

.field private static final BACKGROUND_SELECTED_STATE:[I

.field public static final FACE_DOWN:I = 0x6

.field public static final FACE_UP:I = 0x5

.field public static final FONT_FAMILY_POSITION:I = 0x1

.field public static final FONT_SIZE_POSITION:I = 0x0

.field public static final FONT_STYLE_POSITION:I = 0x3

.field public static final FONT_WEIGHT_POSITION:I = 0x2
...
.method public static buildBackgroundDrawable(Ljava/lang/String;Ljava/lang/String;ZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .param p2, "tileImage"    # Z
    .param p3, "gradientDrawable"    # Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v3, p1, v6, v5, v6}, Lorg/appcelerator/titanium/util/TiFileHelper;->loadDrawable(Ljava/lang/String;ZZZ)Landroid/graphics/drawable/Drawable;
...
.method public static buildBackgroundDrawable(Ljava/lang/String;ZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/StateListDrawable;
    ...
    .param p1, "tileImage"    # Z
    .param p2, "color"    # Ljava/lang/String;
    .param p3, "selectedImage"    # Ljava/lang/String;
    .param p4, "selectedColor"    # Ljava/lang/String;
    .param p5, "disabledImage"    # Ljava/lang/String;
    .param p6, "disabledColor"    # Ljava/lang/String;
    .param p7, "focusedImage"    # Ljava/lang/String;
    .param p8, "focusedColor"    # Ljava/lang/String;
    .param p9, "gradientDrawable"    # Landroid/graphics/drawable/Drawable;
...
.method public static createDensityScaledBitmap(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    .locals 8
    .param p0, "stream"    # Ljava/io/InputStream;
    ...
    :try_start_0
    invoke-static {v5, v6, p0, v4, v3}, Landroid/graphics/BitmapFactory;->decodeResourceStream(Landroid/content/res/Resources;Landroid/util/TypedValue;Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    :try_end_0
    .catch Ljava/lang/OutOfMemoryError; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v5, "TiUIHelper"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "Unable to load bitmap. Not enough memory: "
...
.method public static firePostLayoutEvent(Lorg/appcelerator/titanium/proxy/TiViewProxy;)V
    .locals 3
    .param p0, "proxy"    # Lorg/appcelerator/titanium/proxy/TiViewProxy;
...
.method public static getFontProperties(Lorg/appcelerator/kroll/KrollDict;)[Ljava/lang/String;
    .locals 8
    .param p0, "fontProps"    # Lorg/appcelerator/kroll/KrollDict;
    ...
    .line 553
    .local v2, "fontProperties":[Ljava/lang/String;
    const-string v3, "font"

    invoke-virtual {p0, v3}, Lorg/appcelerator/kroll/KrollDict;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, v3}, Lorg/appcelerator/kroll/KrollDict;->getKrollDict(Ljava/lang/String;)Lorg/appcelerator/kroll/KrollDict;

    move-result-object v1

    .line 556
    .local v1, "font":Lorg/appcelerator/kroll/KrollDict;
    ...
    invoke-static {v1, v3}, Lorg/appcelerator/titanium/util/TiConvert;->toString(Ljava/util/HashMap;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 598
    .end local v1    # "font":Lorg/appcelerator/kroll/KrollDict;
    :cond_3
    :goto_0
    if-nez v0, :cond_4
    ...
    .line 601
    .end local v2    # "fontProperties":[Ljava/lang/String;
    :cond_4
    return-object v2

    .line 569
    .restart local v2    # "fontProperties":[Ljava/lang/String;
    :cond_5
    ...
    invoke-static {p0, v3}, Lorg/appcelerator/titanium/util/TiConvert;->toString(Ljava/util/HashMap;Ljava/lang/String;)Ljava/lang/String;
...
.method public static getRedirectUri(Landroid/net/Uri;)Landroid/net/Uri;
    .locals 9
    .param p0, "mUri"    # Landroid/net/Uri;
...
.method public static getResourceDrawable(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    invoke-static {v0}, Lorg/appcelerator/titanium/util/TiUIHelper;->getResourceDrawable(I)Landroid/graphics/drawable/Drawable;
...
.method public static isAndroidTypeface(Ljava/lang/String;)Z
    .locals 2
...
.method public static linkifyIfEnabled(Landroid/widget/TextView;Ljava/lang/Object;)V
    ...
    .param p1, "autoLink"    # Ljava/lang/Object;
    ...
    invoke-static {p1, v1}, Lorg/appcelerator/titanium/util/TiConvert;->toInt(Ljava/lang/Object;I)I
...
.method public static loadTypeface(Lorg/appcelerator/titanium/TiFileProxy;Ljava/lang/String;)V
    .locals 4
    .param p0, "fontFile"    # Lorg/appcelerator/titanium/TiFileProxy;
    .param p1, "fontFamily"    # Ljava/lang/String;

    .prologue
    .line 436
    invoke-virtual {p0}, Lorg/appcelerator/titanium/TiFileProxy;->exists()Z
    ...
    const-string v3, "Unable to load font from file that not exists"
    ...
    invoke-virtual {v2}, Lorg/appcelerator/titanium/io/TiBaseFile;->name()Ljava/lang/String;
    ...
    .line 449
    .local v1, "tf":Landroid/graphics/Typeface;
    sget-object v3, Lorg/appcelerator/titanium/util/TiUIHelper;->mCustomTypeFaces:Ljava/util/Map;

    monitor-enter v3

    .line 450
    :try_start_0
    sget-object v2, Lorg/appcelerator/titanium/util/TiUIHelper;->mCustomTypeFaces:Ljava/util/Map;
...
.method public static showSoftKeyboard(Landroid/view/View;Z)V
    ...
    invoke-virtual {v5}, Lorg/appcelerator/titanium/util/TiPlatformHelper;->getModel()Ljava/lang/String;
...
.method public static styleText(Landroid/widget/TextView;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .param p2, "fontSize"    # Ljava/lang/String;
    .param p3, "fontWeight"    # Ljava/lang/String;
    .param p4, "fontStyle"    # Ljava/lang/String;
...
.method public static unloadTypeface(Lorg/appcelerator/titanium/TiFileProxy;Ljava/lang/String;)V
    .locals 3
    .param p0, "fontFile"    # Lorg/appcelerator/titanium/TiFileProxy;
    .param p1, "fontFamily"    # Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lorg/appcelerator/titanium/io/TiBaseFile;->name()Ljava/lang/String;
    ...
    .line 463
    :try_start_0
    sget-object v1, Lorg/appcelerator/titanium/util/TiUIHelper;->mCustomTypeFaces:Ljava/util/Map;
