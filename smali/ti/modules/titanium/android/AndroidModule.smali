.class public Lti/modules/titanium/android/AndroidModule;
...
.field public static final PENDING_INTENT_FOR_ACTIVITY:I = 0x0

.field public static final PENDING_INTENT_FOR_BROADCAST:I = 0x2

.field public static final PENDING_INTENT_FOR_SERVICE:I = 0x1

.field public static final PENDING_INTENT_MAX_VALUE:I = 0x2
...
.field private static final TAG:Ljava/lang/String; = "TiAndroid"
...
.method public constructor <init>(Lorg/appcelerator/titanium/TiContext;)V
    ...
    .prologue
    .line 280
    invoke-direct {p0}, Lti/modules/titanium/android/AndroidModule;-><init>()V
...
# virtual methods
.method public createBroadcastIntent([Ljava/lang/Object;)Lorg/appcelerator/titanium/proxy/IntentProxy;
    .locals 2
    ...
    invoke-direct {v0}, Lorg/appcelerator/titanium/proxy/IntentProxy;-><init>()V

    .line 308
    .local v0, "intent":Lorg/appcelerator/titanium/proxy/IntentProxy;
    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Lorg/appcelerator/titanium/proxy/IntentProxy;->setInternalType(I)V

    .line 309
    invoke-virtual {v0, p0, p1}, Lorg/appcelerator/titanium/proxy/IntentProxy;->handleCreationArgs(Lorg/appcelerator/kroll/KrollModule;[Ljava/lang/Object;)V

    .line 310
    return-object v0
.end method

.method public createIntent([Ljava/lang/Object;)Lorg/appcelerator/titanium/proxy/IntentProxy;
    .locals 1
    .param p1, "args"    # [Ljava/lang/Object;
...
.method public createIntentChooser(Lorg/appcelerator/titanium/proxy/IntentProxy;Ljava/lang/String;)Lorg/appcelerator/titanium/proxy/IntentProxy;
    .locals 2
    .param p1, "target"    # Lorg/appcelerator/titanium/proxy/IntentProxy;
    ...
    invoke-direct {v0, v1}, Lorg/appcelerator/titanium/proxy/IntentProxy;-><init>(Landroid/content/Intent;)V

    return-object v0
.end method

.method public createService(Lorg/appcelerator/titanium/proxy/IntentProxy;)Lorg/appcelerator/titanium/proxy/ServiceProxy;
    .locals 1
    ...
    invoke-direct {v0, p1}, Lorg/appcelerator/titanium/proxy/ServiceProxy;-><init>(Lorg/appcelerator/titanium/proxy/IntentProxy;)V

    return-object v0
.end method

.method public createServiceIntent([Ljava/lang/Object;)Lorg/appcelerator/titanium/proxy/IntentProxy;
    .locals 4
    .param p1, "args"    # [Ljava/lang/Object;
    ...
    invoke-virtual {v0, v2}, Lorg/appcelerator/titanium/proxy/IntentProxy;->setInternalType(I)V
    ...
    invoke-virtual {v0, v2}, Lorg/appcelerator/titanium/proxy/IntentProxy;->getProperty(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v1

    .line 298
    .local v1, "startMode":Ljava/lang/Object;
    if-eqz v1, :cond_0
    ...
    invoke-virtual {v0, v2, v3}, Lorg/appcelerator/titanium/proxy/IntentProxy;->putExtra(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public getR()Lorg/appcelerator/titanium/proxy/RProxy;
    ...
    .prologue
    .line 321
    iget-object v0, p0, Lti/modules/titanium/android/AndroidModule;->r:Lorg/appcelerator/titanium/proxy/RProxy;
    ...
    iput-object v0, p0, Lti/modules/titanium/android/AndroidModule;->r:Lorg/appcelerator/titanium/proxy/RProxy;
...
.method public isServiceRunning(Lorg/appcelerator/titanium/proxy/IntentProxy;)Z
    .locals 9
    .param p1, "intentProxy"    # Lorg/appcelerator/titanium/proxy/IntentProxy;
    ...
    .line 354
    const-string v7, "TiAndroid"

    const-string v8, "isServiceRunning called with empty intent.  Will return false, but value is meaningless."
    ...
    const-string v8, "Application instance is no longer available. Unable to check isServiceRunning. Returning false though value is meaningless."
...
.method public registerBroadcastReceiver(Lti/modules/titanium/android/BroadcastReceiverProxy;[Ljava/lang/Object;)V
    .locals 8
    .param p1, "receiverProxy"    # Lti/modules/titanium/android/BroadcastReceiverProxy;
    ...
    .line 383
    .local v1, "actions":[Ljava/lang/Object;
    move-object v2, v1
    ...
    invoke-virtual {v6}, Lorg/appcelerator/titanium/TiApplication;->getApplicationContext()Landroid/content/Context;

    move-result-object v6

    invoke-virtual {p1}, Lti/modules/titanium/android/BroadcastReceiverProxy;->getBroadcastReceiver()Landroid/content/BroadcastReceiver;
    ...
    .line 391
    .end local v1    # "actions":[Ljava/lang/Object;
...
.method public startService(Lorg/appcelerator/titanium/proxy/IntentProxy;)V
    .locals 3
    .param p1, "intentProxy"    # Lorg/appcelerator/titanium/proxy/IntentProxy;
    ...
    invoke-virtual {v0, v1}, Lorg/appcelerator/titanium/TiApplication;->startService(Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    .line 334
    :cond_0
    const-string v1, "TiAndroid"

    const-string v2, "Application instance no longer available. Unable to startService."
...
.method public stopService(Lorg/appcelerator/titanium/proxy/IntentProxy;)V
    .locals 3
    .param p1, "intentProxy"    # Lorg/appcelerator/titanium/proxy/IntentProxy;
    ...
    invoke-virtual {v0, v1}, Lorg/appcelerator/titanium/TiApplication;->stopService(Landroid/content/Intent;)Z
    ...
    const-string v2, "Application instance no longer available. Unable to stopService."
...
.method public unregisterBroadcastReceiver(Lti/modules/titanium/android/BroadcastReceiverProxy;)V
    .locals 4
    .param p1, "receiverProxy"    # Lti/modules/titanium/android/BroadcastReceiverProxy;
    ...
    const-string v3, "Unable to unregister broadcast receiver: "
