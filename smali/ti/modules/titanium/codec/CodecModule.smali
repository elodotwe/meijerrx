...
.method public decodeNumber(Lorg/appcelerator/kroll/KrollDict;)Ljava/lang/Object;
    ...
    const-string v17, "src was not specified for encodeNumber"
    ...
    const-string v17, "type was not specified for encodeNumber"
    ...
    .line 119
    .local v4, "buffer":Lti/modules/titanium/BufferProxy;
    const-string v16, "type"
    ...
    invoke-static/range {v16 .. v16}, Lti/modules/titanium/codec/CodecModule;->getByteOrder(Ljava/lang/Object;)I

    move-result v5

    .line 122
    .local v5, "byteOrder":I
    const/4 v7, 0x0
    ...
    .line 136
    .restart local v10    # "s1":S
    .restart local v11    # "s2":S
    :pswitch_0
