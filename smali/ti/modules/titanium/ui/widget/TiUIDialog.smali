...
# instance fields
.field protected builder:Landroid/support/v7/app/AlertDialog$Builder;
...
.method private createBuilder()V
    ...
    iput-object v2, p0, Lti/modules/titanium/ui/widget/TiUIDialog;->builder:Landroid/support/v7/app/AlertDialog$Builder;

    .line 328
    iget-object v2, p0, Lti/modules/titanium/ui/widget/TiUIDialog;->builder:Landroid/support/v7/app/AlertDialog$Builder;
    ...
    invoke-direct {v2, v1, v3, v5, v4}, Lorg/appcelerator/titanium/TiBaseActivity$DialogWrapper;-><init>(Lorg/appcelerator/titanium/TiBaseActivity;Landroid/app/Dialog;ZLjava/lang/ref/WeakReference;)V
...
.method private getBuilder()Landroid/support/v7/app/AlertDialog$Builder;
    .locals 1

    .prologue
    .line 69
    iget-object v0, p0, Lti/modules/titanium/ui/widget/TiUIDialog;->builder:Landroid/support/v7/app/AlertDialog$Builder;
...
.method private processButtons([Ljava/lang/String;)V
    ...
    .line 126
    invoke-direct {p0}, Lti/modules/titanium/ui/widget/TiUIDialog;->getBuilder()Landroid/support/v7/app/AlertDialog$Builder;

    move-result-object v3

    invoke-virtual {v3, v4, v4}, Landroid/support/v7/app/AlertDialog$Builder;->setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/AlertDialog$Builder;
    ...
    invoke-virtual {v3, v4, v4}, Landroid/support/v7/app/AlertDialog$Builder;->setNegativeButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/AlertDialog$Builder;
    ...
    invoke-virtual {v3, v4, v4}, Landroid/support/v7/app/AlertDialog$Builder;->setNeutralButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/AlertDialog$Builder;
    ...
    invoke-virtual {v3, v2, v0}, Landroid/support/v7/app/AlertDialog$Builder;->setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/AlertDialog$Builder;
    ...
    invoke-virtual {v3, v2, v0}, Landroid/support/v7/app/AlertDialog$Builder;->setNeutralButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/AlertDialog$Builder;
    ...
    invoke-virtual {v3, v2, v0}, Landroid/support/v7/app/AlertDialog$Builder;->setNegativeButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/AlertDialog$Builder;
...
.method private processOptions([Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, p1, p2, v1}, Landroid/support/v7/app/AlertDialog$Builder;->setSingleChoiceItems([Ljava/lang/CharSequence;ILandroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/AlertDialog$Builder;
...
.method public propertyChanged(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Lorg/appcelerator/kroll/KrollProxy;)V
    ...
    invoke-virtual {v4}, Lorg/appcelerator/titanium/TiBaseActivity$DialogWrapper;->getDialog()Landroid/app/Dialog;
    ...
    invoke-virtual {v0, p3}, Landroid/support/v7/app/AlertDialog;->setTitle(Ljava/lang/CharSequence;)V
    ...
    .end local p3    # "newValue":Ljava/lang/Object;
    invoke-virtual {v0, p3}, Landroid/support/v7/app/AlertDialog;->setMessage(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v4, v7}, Landroid/support/v7/app/AlertDialog$Builder;->setView(Landroid/view/View;)Landroid/support/v7/app/AlertDialog$Builder;
...
.method public show(Lorg/appcelerator/kroll/KrollDict;)V
    ...
    invoke-virtual {v6}, Lorg/appcelerator/titanium/TiBaseActivity$DialogWrapper;->getDialog()Landroid/app/Dialog;
    ...
    invoke-virtual {v6, v7}, Lorg/appcelerator/titanium/TiBaseActivity$DialogWrapper;->setActivity(Ljava/lang/ref/WeakReference;)V
    ...
    invoke-virtual {v6, v7}, Landroid/support/v7/app/AlertDialog$Builder;->setOnCancelListener(Landroid/content/DialogInterface$OnCancelListener;)Landroid/support/v7/app/AlertDialog$Builder;
    ...
    invoke-virtual {v6, v0}, Lorg/appcelerator/titanium/TiBaseActivity$DialogWrapper;->setDialog(Landroid/app/Dialog;)V

    .line 289
    const/4 v6, 0x0

    iput-object v6, p0, Lti/modules/titanium/ui/widget/TiUIDialog;->builder:Landroid/support/v7/app/AlertDialog$Builder;
